    ...
    return (
        <div className='flex flex-row justify-between w-full'>
            <div className="w-56 h-56 bg-red-100 ml-12">
                ...
                <MercenaryCard player={1} setPlayerOneValue={setPlayerOneValue} source={require('../../assets/characters/png/char3.png')} type={"top_right"} />
                <MercenaryCard player={1} setPlayerOneValue={setPlayerOneValue} source={require('../../assets/characters/png/char1.png')} type={"top_middle"} />
                <MercenaryCard player={1} setPlayerOneValue={setPlayerOneValue} source={require('../../assets/characters/png/char9.png')} type={"top_left"} />
            ...
            <div className="w-56 h-56 bg-blue-100 mr-12">
                ...
                <MercenaryCard player={2} setPlayerTwoValue={setPlayerTwoValue} source={require('../../assets/characters/png/char2.png')} type={"bottom_right"} />
                <MercenaryCard player={2} setPlayerTwoValue={setPlayerTwoValue} source={require('../../assets/characters/png/char1.png')} type={"bottom_middle"} />
                <MercenaryCard player={2} setPlayerTwoValue={setPlayerTwoValue} source={require('../../assets/characters/png/char1.png')} type={"bottom_left"} />
