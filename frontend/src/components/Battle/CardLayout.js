    ...
    return (
        <div className='flex flex-row justify-between w-full'>
            <div className="w-56 h-56 bg-red-100 ml-12">
                ...
                <MercenaryCard player={1} setPlayerOneValue={setPlayerOneValue} source={require('../../assets/characters/png/char5.png')} type={"top_middle"} />
            ...
            <div className="w-56 h-56 bg-blue-100 mr-12">
                ...
                <MercenaryCard player={2} setPlayerTwoValue={setPlayerTwoValue} source={require('../../assets/characters/png/char7.png')} type={"bottom_middle"} />
                <MercenaryCard player={2} setPlayerTwoValue={setPlayerTwoValue} source={require('../../assets/characters/png/char4.png')} type={"bottom_left"} />
